...
const keystoreDir = '/home/speedy/test-net/Node1/key/keystore';
...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=/home/speedy/test-net/Node1/config/configNode1.toml --node-private-key-file="${tempPrivateKeyFilePath}"`;
