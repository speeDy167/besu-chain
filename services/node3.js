...
const keystoreDir = '/home/kyo/test-net/Node3/key/keystore';
...
rl.question('', (password) => {
  ...
  try {
    ...
    const besuCommand = `besu --config-file=/home/kyo/test-net/Node3/config/configNode3.toml --node-private-key-file="${tempPrivateKeyFilePath}"`;
